...
public class ReviewService {
	...
	public Review createReview(@PathVariable("criticId") int criticId, @PathVariable("songId") int songId, @RequestBody Review review) {
		Reviewer critic = criticService.findReviewerById(criticId);
	...
	public List<Review> findReviewByReviewerForSong(@PathVariable("criticId") int criticId, @PathVariable("songId") int songId) {
		
		return (List<Review>) reviewRepository.findReviewByCrticSong(criticService.findReviewerById(criticId), songService.findSongById(songId));
	}
