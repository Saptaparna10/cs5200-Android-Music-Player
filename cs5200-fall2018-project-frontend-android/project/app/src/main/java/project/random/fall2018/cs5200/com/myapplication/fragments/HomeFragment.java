...
import project.random.fall2018.cs5200.com.myapplication.adapters.SongListAdapter;
...
public class HomeFragment extends Fragment {
    ...
    public void inflateSongListView(SongListValueObject songList){
        mSongListAdapter = new SongListAdapter(songList.getTracks().getTrack(),getActivity());
